...
urlpatterns = [
    ...
    path('learners/', views.ListLearnerView.as_view(), name='learners'),  # delete if wrong
    path('instructors/', views.ListInstructorView.as_view(), name='instructors'),  # delete if wrong
    path('alcourse/', views.ListCourseView.as_view(), name='alcourse'),
    path('aduser/<int:pk>', views.ADeleteuser.as_view(), name='aduser'),
    path('adcourse/<int:pk>', views.ADeleteCourse.as_view(), name='adcourse'),
    ...
    path('takenquiz/<int:pk>/retake/', views.LTakenQuizDeleteView, name='takenquiz_delete'),
